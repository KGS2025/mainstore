...
<div class="prod-detail product_display_<?php echo $product->id; ?>">
    ...
    <div class="minimize_block_<?php echo htmlspecialchars($tbl_product_type_id); ?>">
		...
		<div class="col-lg-6">
				  <div class="slider-for">
				    ...
				    <div class="slider-nav">
                        ...
                        foreach ($pro_real_images as $single_real_image) {
                        if (isset($single_real_image) && $single_real_image != '' && file_exists("assets/uploads/product_images/" . $single_real_image)) {?>
                        <div><div class="fig"><img src="<?php echo asset_url(); ?>/assets/uploads/product_images/<?php echo $single_real_image; ?>"></div></div>
		...
		<div class="col-lg-6 prod-descp">
			...
			<p class="ele_price">
				<span class="label"><strong><?=$product_instruction->price;?> :</strong></span>
				<span class="value"><?php echo $price . ' ' . $currency; ?></span>
			</p>
			<p>
				<span><strong><?=$product_instruction->part_number;?>:</strong></span>
				<span><?php echo $product->kgt_ref_number; ?></span>
			</p>
			<p>
