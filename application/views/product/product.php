...
<div class="mainContent px-3 px-lg-5">
    ...
    <?php if($this->config->item('menu_theme_settings')=="1" && $this->config->item('enable_banner')=="1"){?>	
	<?php $this->load->view('elements/body_logo_new1'); ?>
    <?php }else{?>
    ...
    <div class="ct-videoSection">
		...
		<div class="ct-team-box p-0">
            <div class="home-mobile-search-wrap">
                <div class="text-header1 common-search">
                            <div class="home-quick-search-wrap1 float-start w-100">
    ...
    <div class="car-lists productbaselisting float-start w-100">
        <div class="ct-videoSection">
            <div class="ct-services">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="ct-team-box p-0">
                        <div class="home-quick-search-wrap float-start w-100 upper_quick_search" style="display: none;">
        ...
        <form class="float-start w-100" action="<?php echo base_url() . $lang_id . '/'; ?>products/product_maker" id="products_catagory_list_form" enctype="multipart/form-data" method="post" autocomplete="off">
            ...
            <div class="product-list float-start w-100">
                <div class="upper_search_block">
                    <div class="ProductNote float-start w-100 py-2 text-center search_radio">
 ...
 ?>
                ...
                <div class="category-list filter-list <?php if ($disable_multiselect == 1) echo "disable-multi-select";?>" style="<?php if ($default_quick_search != 'category') {
                    ...
                    <span id="vehicle_check_all_btn" class="custom_btn mb-3 d-inline-flex align-items-center position-relative" style="<?php if ($disable_multiselect == 1) echo "display:none !important;";?>">
		    ...
		    <span id="brand_check_all_btn" class="custom_btn mb-3 d-inline-flex align-items-center position-relative" style="<?php if ($disable_multiselect == 1) echo "display:none !important;";?>">
                ...
                <div class="product-group-list filter-list <?php if ($disable_multiselect == 1) echo "disable-multi-select";?>" style="<?php if ($default_quick_search != 'product-group') {
					...
					<span id="product_check_all_btn" class="custom_btn mb-3 d-inline-flex align-items-center position-relative" style="<?php if ($disable_multiselect == 1) echo "display:none !important;";?>">
                                ...
                                <?php foreach ($industry_list as $inds_type) { ?>
                                    <div class="ProductBlock" style="margin-bottom: 20px;">
                                        <div class="VehicleBlockItems h-float">
                                            <div class="pro-item product_type_image_wrap industry_category_image_wrap stepind product_group_image_wrap">
...
<script type="text/javascript">
    window.addEventListener('scroll', function() {
        var moreButton = document.getElementById('more_button_home_product_list');
        var target = document.querySelector('.product-list-list');
