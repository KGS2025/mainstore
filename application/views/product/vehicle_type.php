    ...
    <form action="<?php echo base_url() . $lang_id . '/'; ?>products/product_maker" id="products_type_list_form" enctype="multipart/form-data" method="post">
        ...
        <div class="main-page">
            ...
            <span class="custom_btn mt-3 mb-0 d-inline-flex align-items-center position-relative">
                <input type="checkbox" class="category-list-box" <?php echo ($disable_multiselect==1?"disabled":"");?> />
                <label for="Checkbox_all"></label>
                <span><?php echo $general_instruction->select_all; ?></span>
            </span>

            <div class="car-lists text-center productbaselisting mb-4 <?php echo ($disable_multiselect==1?"disable-multi-select":"");?>">
                        ...
                        <?php foreach ($vehicle_categories as $vehicle) {
                            if ($vehicle['status'] == "1") { ?>
                                <?php if (empty($vehicle_category_ids) || (!empty($vehicle_category_ids) && in_array($vehicle['id'], $vehicle_category_ids))) { ?>
                                    <div class="ProductBlock <?php echo ($disable_multiselect==1?"disable-multi-select":"");?>">
            ...
            <div class="nav-prex-next text-right removebuttons productBtns">
                <a href="<?php echo $backUrl; ?>" class="btn  actn-btn rounded" <?php if ($disable_multiselect == 1) {echo "style='display:none'";};?>><?php echo $general_instruction->back; ?> </a>
                <a href="javascript:void(0);" class="btn  actn-btn rounded" id="product_type_next" <?php if ($disable_multiselect == 1) {echo "style='display:none'";};?>><?php echo $general_instruction->next; ?> </a>
            </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 s_button sticky_bottom productBtnsFixedBottom py-2 py-md-3 px-3 px-md-5" style="display: none;">
    <div class="nav-prex-next sticky_button_next flex-wrap align-items-center justify-content-between w-100">
        ...
        <div class="productActionBtns d-flex align-items-center">
            <a href="<?php echo $backUrl; ?>" class="btn  actn-btn rounded cart_back_btn_color" <?php if ($disable_multiselect == 1) {echo "style='display:none'";};?>><?php echo $general_instruction->back; ?> </a>
