...
<div class="prod-detail product_display_<?php echo $product->id; ?>">
    ...
    if ($this->config->item('enable_distributor_feature') == "0" || ($this->config->item('enable_distributor_feature') == "1" && empty($product_distributor))) {
        ...
        ?>
                                <span class="position-relative"  style="<?php echo ($disable_multiselect==1?"display:none !important;":"");?>">
    ...
    foreach ($product_distributor as $single_distributor) {?>
                            
                             <div class="h-col d-flex flex-column">
                             <div class="h-label">
                                <a href="<?php echo $single_distributor['url']; ?>/cart/move_to_cart/<?php echo urlencode(base64_encode($product->kgt_ref_number)); ?>" target="_blank"><?php echo $single_distributor['name']; ?></a>

                               </div>

                               <div class="h-value red">
                                    <a href="<?php echo $single_distributor['url']; ?>/cart/move_to_cart/<?php echo urlencode(base64_encode($product->kgt_ref_number)); ?>" target="_blank" class="btn btn-blue"><?php echo $general_instruction->buynow; ?></a>
                                    </div>
		...
		<div class="col-lg-6 prod-descp">
            ...
            <?php if ($storeQuantity > 0) {?>
                <p>
                    ...
                    <span>In stock (<?php echo $storeQuantity;?> units), ready to be shipped</span>
                </p>
            <?php }?>
            <?php if ($product->make) {
                ...
                ?>
                <p>
                    <span><?php //echo $product->make;?></span><?php echo $maker_logo;?>
                </p>
            <?php }?>
            <?php if ($product->model) {
                    
                    if (isset($product->model_photo) && $product->model_photo != '' && file_exists("assets/uploads/product_model/" . $product->model_photo)) {
                        $comingsoon = getNoImage('coming-soon');
                        $model_logo = '<img class="brandmodeltitlelogo px-2" src=" ' . asset_url() . '/assets/uploads/product_model/' . $product->model_photo . '" data-img="' . asset_url() . '/assets/uploads/product_model/' . $product->model_photo. '" alt="' . $product->model . '" />';
                    } else {
                        $model_logo = '<img class="brandmodeltitlelogo px-2" src="' . $comingsoon . '" data-img="' . $comingsoon . '" alt="coming soon" />';
                    }
                ?>
                <p>     
                   <span><strong><?=$product_instruction->product_model_title;?> :</strong></span>                
...
<?php if($view_type!=1){ ?>
		<p>
            <span><a href="<?php echo $product->url; ?>/cart/move_to_cart/<?php echo urlencode(base64_encode($product->kgt_ref_number)); ?>" class="btn  actn-btn rounded"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;<?php echo $general_instruction->addtocart; ?></a></span>
		</p>
<?php }?>
		</div>
	 </div>
    ...
    ?>
        ...
        ?>
            ...
            <td class="font575757 width60px">
                <span class="item_count_product"><?php echo $i; ?></span>
            </td>
