...
$ar_parents_childs['childs']=array();
	...
	if($ar_parents_childs['parents'] || $ar_parents_childs['childs']){
		...
		if($ar_parents_childs['parents']){
		  ...
		  if($ar_count == 1){
			echo '<br/> Parent: '.implode(", ",$ar_parents_childs['parents']); 
		  }else{
			echo '<br/>'.$ar_count.' Parents: '.implode(", ",$ar_parents_childs['parents']); 
		  }
		} 
		if($ar_parents_childs['childs']){
			$ar_count=count($ar_parents_childs['childs']);
			if($ar_count == 1){
			  echo '<br/> Child: '.implode(", ",$ar_parents_childs['childs']); 
			}else{
			  echo '<br/>'.$ar_count.' Childs: '.implode(", ",$ar_parents_childs['childs']); 
			}
		} 
	}
               ################
