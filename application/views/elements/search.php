<div class="main-col  home-mobile-search-wrap">
    <div class="search-result-wrapper">
        ...
        <div class="right-box-input position-relative">
			<div class="input-field-card">
				<input id="Search" type="text" name="Articles" placeholder="<?php echo str_replace('Articles','',$general_instruction->search_articles); ?>" autocomplete="off"/>
