                        ...
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <h5>
                                        <?php echo $admin_user_details['refferaluser_details']['admin']; ?>
                                    </h5>
                                    <?php if ($lang_id == $primary_lang && ((isset($access['page_add']) && $access['page_add'] == 1) || (isset($access['page_edit']) && $access['page_edit'] == 1))) { ?>
                                        ...
                                        <input type="text" value="<?php echo $admin_user_details['refferaluser_details']['admin']; ?>" class="edit_input_text" style="display: none;">
                                        <input type="hidden" value="<?php echo base_url() . 'admin/' . $lang_id . '/multilangue/saveLanguageData/admin_user_details/refferaluser_details'; ?>">
                                    <?php } ?>
                                    <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_user_details/refferaluser_details/admin" class="fancybox multi_language_common_edit admin_globe">
                                        ...
                                        <div class="dataTables_length" id="data-table_length">
                                            <label>
                                                <div id="" class="selector">
                                                    <a class="floatright" tabindex="0" id="data-table_first" href="admin/<?php echo $lang_id; ?>/referralusers/add"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                                </div>
                                            </label>
                                        </div>
                                    <?php } ?>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top" class="width85px">
                                                            <?php if (isset($access['page_edit']) && $access['page_edit'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/referralusers/edit/<?php echo $set_data->id; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                                <?php } ?>&nbsp;&nbsp;
                                                                <a href="admin/<?php echo $lang_id; ?>/referralusers/delete/<?php echo $set_data->id; ?>" onclick="return confirm_box();"><?php echo $admin_static_links['static_delete']['front']; ?></a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    $i++;
...
<script type="text/javascript">
    function language_status(name, id, value) {
        $.ajax({
            type: "POST",
            url: "admin/<?php echo $lang_id; ?>/referralusers/update_status",
