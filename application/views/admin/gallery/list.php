        ...
        <div class="inner">
            <div class="page-header">
                ...
                <div class="body">
                    ...
                    <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/gallery/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                  <h5>
                                    ...
                                    <?php echo $admin_gallery['gallery']['admin']; ?>
                                  </h5>
                                  ...
                                  <input type="text" value="<?php echo $admin_gallery['gallery']['admin']; ?>" class="edit_input_text"  style="display: none;">
                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData/admin_gallery/gallery'; ?>">
                                  <?php } ?>
                                  <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_gallery/gallery/admin" class="fancybox multi_language_common_edit admin_globe">
                                            ...
                                            <label>
                                                <div id="" class="selector">
                                                    <a class="floatright" tabindex="0"
                                                       id="data-table_first" href="admin/<?php echo $lang_id; ?>/gallery/add_gallery"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                                </div>
                                            </label>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th>
                                                  <label class="control-label"><?php echo $admin_gallery['srno']['admin']; ?></label>
                                                  <?php if ($lang_id == $primary_lang && ((isset($access['page_add']) && $access['page_add'] == 1) || (isset($access['page_edit']) && $access['page_edit'] == 1))) { ?><div class="edit_text" style="display:block"></div>
                                                  <input type="text" value="<?php echo $admin_gallery['srno']['admin']; ?>" class="edit_input_text"  style="display: none;">
                                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData/admin_gallery/srno'; ?>">
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_gallery/srno/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_gallery/name/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                ...
                                                <th>
                                                  ...
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_gallery/gallery_url/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <?php if (isset($access['page_edit']) && $access['page_edit'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/gallery/edit_gallery/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                            <?php } ?>
    ...
    function confirm_box(storeId) {
        var answer = confirm("<?php echo $admin_static_links['are_you_sure']['front']; ?>");
            if (!answer){
                ...
                window.location.href = "<?= 'admin/'.$lang_id.'/gallery/delete_gallery/';?>"+storeId;
            }
    }
</script>
