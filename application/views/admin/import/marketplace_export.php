                                ...
                                <div class="block well">
                                    <div class="navbar">
                                        <div class="navbar-inner">
                                            <h5> <?php echo $admin_products['marketplace_export']['front']; ?></h5>
                                            <?php if ($lang_id == $primary_lang) { ?><div class="edit_text" style="display:block"></div>
                                                <input type="text" value="<?php echo $admin_products['marketplace_export']['front']; ?>" class="edit_input_text" style="display: none;">
                                                <input type="hidden" value="<?php echo base_url() . 'admin/' . $lang_id . '/multilangue/saveLanguageData/admin_products/marketplace_export/front'; ?>">
                                            <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_products/marketplace_export/front" class="fancybox multi_language_common_edit admin_globe">
 ...
 -->
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="control-group" id="Import_question">
                                            ...
                                            <label class="control-label"><?php echo $admin_importdata['marketplace_export_question']['admin']; ?></label>

                                            <?php if ($lang_id == $primary_lang) { ?><div class="edit_text" style="display:block"></div>
                                                <input type="text" value="<?php echo $admin_importdata['marketplace_export_question']['admin']; ?>" class="edit_input_text" style="display: none;">
                                                <input type="hidden" value="<?php echo base_url() . 'admin/' . $lang_id . '/multilangue/saveLanguageData/admin_importdata/marketplace_export_question'; ?>">
                                            <?php } ?>
                                            <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_importdata/marketplace_export_question/admin" class="fancybox multi_language_common_edit admin_globe">
                                                <img src="assets/uploads/global.jpg" height="20" width="20">
                                            </a>
                                    ...
                                    <form id="selectedproducts" name="importattribute" class="form-horizontal importforms" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/importdata/marketplace_export">
                                        ...
                                        <div class="form-actions align-right">
                                            ...
                                            <input class="btn btn-primary" value="<?php echo $admin_static_links['sbmt']['front']; ?>" type="submit">
                                        </div>
                                    </form>
                                    ...
                                    <form id="rangeproduct" name="importattribute" class="form-horizontal importforms" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/importdata/marketplace_export">
                                        <input type="hidden" name="operation" value="set" />
                                        ...
                                        <div class="control-group">
                                            <label class="control-label"><?php echo $admin_importdata['range_product']['admin']; ?>:</label>
                                            <?php if ($lang_id == $primary_lang) { ?><div class="edit_text" style="display:block"></div>
                                        ...
                                        <div class="form-actions align-right">
                                            ...
                                            <input class="btn btn-primary images_download_limit" value="<?php echo $admin_static_links['sbmt']['front']; ?>" id="send" type="submit">
                                        </div>
                                    </form>
                                </div>
        ...
        $("#rangeproduct").validate({
            ...
            messages: {
                ...
                limit: {
                    ...
                    range: "<?php echo $form_validation_instruction->range_to_hundred; ?>"
                }
            },
            errorElement: "p",
            errorClass: 'help-block red1',
