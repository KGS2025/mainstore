        ...
        <div class="inner">
            <div class="page-header">
                ...
                <div class="body">
                    ...
                    <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/homepagesetting/navigation_setting" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                  ...
                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_navigation_pages/pages_main_text'; ?>">
                                  <?php } ?>
                                  <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_navigation_pages/pages_main_text/admin" class="fancybox multi_language_common_edit admin_globe">
                                            ...
                                            <label>
                                                <div id="" class="selector">
                                                    <a class="floatright" tabindex="0"
                                                       id="data-table_first" href="admin/<?php echo $lang_id; ?>/homepagesetting/add_navigation_page"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                                </div>
                                            </label>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th>
                                                  ...
                                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_navigation_pages/srno'; ?>">
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_navigation_pages/srno/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_navigation_pages/title'; ?>">
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_pages_country/title/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_navigation_pages/page_url'; ?>">
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_navigation_pages/page_url/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                            </tr>
                                                ...
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <?php if(isset($set_data['lang_title']) && $set_data['lang_title'] != '') { ?>
                                                                <?php echo $set_data['lang_title']; ?>
                                                            <?php } else { ?>
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <a target="_blank" href="<?php echo $set_data['page_url']; ?>"><?php echo $set_data['page_url']; ?></a>
                                                        </td>
                                                        <td class="dataTables" valign="top">
                                                            <?php if (isset($access['page_edit']) && $access['page_edit'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/homepagesetting/edit_navigation_page/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                            <?php } ?>
                                                            <?php if (isset($access['page_delete']) && $access['page_delete'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/homepagesetting/delete_navigation_page/<?php echo $set_data['id']; ?>"
