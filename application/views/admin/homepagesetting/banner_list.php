        ...
        <div class="inner">
            <div class="page-header">
                ...
                <div class="body">
                    ...
                    <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/homepagesetting/banner_setting" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                  ...
                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_banner_images/pages_main_text'; ?>">
                                  <?php } ?>
                                  <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_banner_images/pages_main_text/admin" class="fancybox multi_language_common_edit admin_globe">
                                            ...
                                            <label>
                                                <div id="" class="selector">
                                                    <a class="floatright" tabindex="0"
                                                       id="data-table_first" href="admin/<?php echo $lang_id; ?>/homepagesetting/add_banner_image"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                                </div>
                                            </label>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th>
                                                  ...
                                                  <input type="hidden" value="<?php echo base_url() . 'admin/'.$lang_id.'/multilangue/saveLanguageData//admin_banner_images/srno'; ?>">
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_banner_images/srno/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_banner_images/banner_image/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_banner_images/button_text/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                                <th>
                                                  ...
                                                  <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_banner_images/button_url/admin" class="fancybox multi_language_common_edit admin_globe">
                                                        <img src="assets/uploads/global.jpg" height="20" width="20" >
                                                    </a>
                                                </th>
                                            ...
                                            if (isset($all_data)) {
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <img src="assets/uploads/banner_images/<?php echo $set_data['banner_image'] ?>" class="img-responsive" height="100px" width="100px" />
                                                        </td>
                                                        <td class="dataTables" valign="top">
                                                            <?php if(isset($set_data['lang_button_text']) && $set_data['lang_button_text'] != '') { ?>
                                                                <?php echo $set_data['lang_button_text']; ?>
                                                            <?php } else { ?>
                                                                <?php echo $set_data['button_text']; ?>
                                                            <?php } ?>
                                                        </td> 

                                                        <td class="dataTables" valign="top">
                                                            <?php if(isset($set_data['lang_button_url']) && $set_data['lang_button_url'] != '') { ?>
                                                                <?php echo $set_data['lang_button_url']; ?>
                                                            <?php } else { ?>
                                                                <?php echo $set_data['button_url']; ?>
                                                            <?php } ?>
                                                        </td> 
                                                        
                                                        <td class="dataTables" valign="top">
                                                            <?php if (isset($access['page_edit']) && $access['page_edit'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/homepagesetting/edit_banner_image/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                            <?php } ?>
                                                            <?php if (isset($access['page_delete']) && $access['page_delete'] == 1) { ?>
                                                                <a href="admin/<?php echo $lang_id; ?>/homepagesetting/delete_banner_image/<?php echo $set_data['id']; ?>"
