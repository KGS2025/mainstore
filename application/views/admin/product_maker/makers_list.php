    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                ...
                <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/makers/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <!-- Content container -->
                    <div class="container">
                        <!-- Default datatable -->
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <h5><?php echo $admin_products['product_maker']['front']; ?></h5>
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/makers/index" method="post"
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/<?php echo $lang_id; ?>/makers/add_productmakers"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                            </div>
                                        </label>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th><?php echo $admin_products['vehicle_brand_logo']['front']; ?></th>
                                                <th><?php echo $admin_products['category_name']['front']; ?></th>
                                                ...
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <?php
                                                            if (isset($set_data['maker_logo']) && $set_data['maker_logo'] != '' && file_exists("assets/uploads/product_maker/" . $set_data['maker_logo'])) {
                                                                $image = 'assets/uploads/product_maker/' . $set_data['maker_logo'];
                                                            } else {
                                                                $image = $noimage;;
                                                            }
                                                            ?>
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <?php } else { ?>
                                                                <?php echo $set_data['category_name'] ? $set_data['category_name'] : '--'; ?>
                                                            <?php } ?>    
                                                        </td>
                                                        <td class="dataTables" valign="top">
                                                            <?php
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <a href="admin/<?php echo $lang_id; ?>/makers/edit_maker/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                             <?php } ?>
                                                            <?php if (isset($access['page_delete']) && $access['page_delete'] == 1) { ?>
                                                            <a href="admin/<?php echo $lang_id; ?>/makers/delete_maker/<?php echo $set_data['id']; ?>"
