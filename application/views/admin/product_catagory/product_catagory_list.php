    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <div class="body">
                    <!-- Content container -->
                    <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/vehicle_categories/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="container">
                        <!-- Default datatable -->
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <h5><?php echo $admin_products['vehicle_category']['front']; ?></h5>
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/vehicle_categories/index" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="controls">
                                                <input type="search" id="search" name="search" class="focustip span6" value="<?php echo $search; ?>"/>
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first"
                                                   href="<?php echo base_url() . 'admin/' . $lang_id; ?>/vehicle_categories/add_product_category"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                            </div>
                                        </label>
                                    </div>
                                    <?php } ?>
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th><?php echo $admin_products['vehicle_category']['front']; ?></th>
                                            <th><?php echo isset($admin_products['kgt_vehicle_category_generic_photo']['front']) ? $admin_products['kgt_vehicle_category_generic_photo']['front'] : ''; ?></th>
                                            <th><?php echo $admin_products['category_icon']['front']; ?></th>
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <?php if(isset($set_data['lang_category_name']) && $set_data['lang_category_name'] != '') { ?>
                                                        <?php echo $set_data['lang_category_name']; ?>
                                                        <?php } else { ?>
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <?php
                                                            if (isset($set_data['VehicleType_Photo']) && $set_data['VehicleType_Photo'] != '' && file_exists("assets/uploads/vehicle_categories/" . $set_data['VehicleType_Photo'])) {
                                                                $image1 = 'assets/uploads/vehicle_categories/' . $set_data['VehicleType_Photo'];
                                                            } else {
                                                                $image1 = $noimage;;
                                                            }
                                                            ?>
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <?php
                                                            if (isset($set_data['vehicle_category_icon']) && $set_data['vehicle_category_icon'] != '' && file_exists("assets/uploads/vehicle_categories/" . $set_data['vehicle_category_icon'])) {
                                                                $image2 = 'assets/uploads/vehicle_categories/' . $set_data['vehicle_category_icon'];
                                                            } else {
                                                                $image2 = $noimage;;
                                                            }
                                                            ?>
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="<?php echo base_url() . 'admin/' . $lang_id; ?>/vehicle_categories/edit_product_category/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                        <?php } ?>
                                                        <?php if (isset($access['page_delete']) && $access['page_delete'] == 1) { ?>
                                                        <a href="<?php echo base_url() . 'admin/' . $lang_id; ?>/vehicle_categories/delete/<?php echo $set_data['id']; ?>"
