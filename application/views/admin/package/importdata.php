                                ...
                                <div class="block well">
                                    <div class="navbar">
                                        <div class="navbar-inner">
                                            <h5> <?php echo $admin_products['add_importdata_package']['front']; ?></h5>
                                            <?php if ($lang_id == $primary_lang) { ?><div class="edit_text" style="display:block"></div>
                                                <input type="text" value="<?php echo $admin_products['add_importdata_package']['front']; ?>" class="edit_input_text" style="display: none;">
                                                <input type="hidden" value="<?php echo base_url() . 'admin/' . $lang_id . '/multilangue/saveLanguageData/admin_products/add_importdata_package/front'; ?>">
                                            <?php } ?><a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_products/add_importdata_package/front" class="fancybox multi_language_common_edit admin_globe">
                                    ...
                                    <form id="importproduct" name="importproduct" class="form-horizontal importforms" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/package/import_packages">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <a class="btn btn-primary" href="admin/<?php echo $lang_id; ?>/package/package_download"> <?php echo $admin_static_links['download_file']['front']; ?> </a>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label"><?php echo $admin_importdata['importproductpackage_label']['admin']; ?>:</label>
                                            <?php if ($lang_id == $primary_lang) { ?><div class="edit_text" style="display:block"></div>
                                                <input type="text" value="<?php echo $admin_importdata['importproductpackage_label']['admin']; ?>" class="edit_input_text" style="display: none;">
                                                <input type="hidden" value="<?php echo base_url() . 'admin/' . $lang_id . '/multilangue/saveLanguageData/admin_importdata/importproductpackage_label'; ?>">
                                            <?php } ?>
                                            <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/saveLanguageDataByCountry/admin_importdata/importproductpackage_label/admin" class="fancybox multi_language_common_edit admin_globe">
                                                <img src="assets/uploads/global.jpg" height="20" width="20">
                                            </a>
                        ...
                        success: function(msg) {
                            if (msg.status == 1) {
                                ...
                                setTimeout(function() {
                                    ...
                                    window.location.href = '<?php echo base_url() . "admin/" . $lang_id . "/package"; ?>';
