        ...
        <div class="inner">
            <div class="page-header">
                <div class="body">
                    ...
                    <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/product_type/index" method="post" enctype="multipart/form-data"> 
                    <!-- Content container -->
                    <div class="container">
                        <!-- Default datatable -->
                        <div class="block well margintop-30px">
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <h5><?php echo $admin_products['product_type_title']['front']; ?></h5>
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/product_type/index" method="post"
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first"
                                                   href="admin/<?php echo $lang_id; ?>/product_type/add_producttype"><?php echo $admin_static_links['static_add']['front']; ?></a>
                                            </div>
                                        </label>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th><?php echo $admin_products['product_type_name']['front']; ?></th>
                                                <th><?php echo $admin_products['product_type_image']['front']; ?></th>
                                            ...
                                            if (isset($all_data)) {
                                                foreach ($all_data as $set_data) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <?php
                                                            if (isset($set_data['Product_Type_Photo']) && $set_data['Product_Type_Photo'] != '' && file_exists("assets/uploads/product_type_images/" . $set_data['Product_Type_Photo'])) {
                                                                $image = 'assets/uploads/product_type_images/' . $set_data['Product_Type_Photo'];
                                                            } else {
                                                                $image = $noimage;;
                                                            }
                                                            ?>
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            <a href="admin/<?php echo $lang_id; ?>/product_type/edit_product/<?php echo $set_data['id']; ?>"><?php echo $admin_static_links['static_edit']['front']; ?></a>&nbsp;&nbsp;
                                                            <?php } ?>
                                                            <?php if (isset($access['page_delete']) && $access['page_delete'] == 1) { ?>
                                                            <a href="admin/<?php echo $lang_id; ?>/product_type/delete_product/<?php echo $set_data['id']; ?>"
