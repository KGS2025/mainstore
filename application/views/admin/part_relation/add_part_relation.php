...
<!-- bof AR -->
                                    <!-- This is for hide_partid in frontend -->
                                        ...
                                        <!-- This is start of SEO module  -->
                                                                                
                                        <div class="control-group">
                                            <label class="control-label">SEO Description:</label>
                                            <div class="controls">
                                                <input id="seo_meta_desc" name="seo_meta_desc" class="focustip span12" type="text" value="" placeholder ="Enter SEO description">
                                               </div>  
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="seo_meta_keywords" name="seo_meta_keywords" class="focustip span12" type="text" value="" placeholder ="Enter SEO keywords">
                                         </div>                          

                                    <!-- This is END of SEO Module -->
<!-- eof AR -->
