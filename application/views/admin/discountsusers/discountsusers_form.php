    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <div class="body">
                    <div class="container">
                        <form id="discount_coupon_form" action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/discountsusers/save_data" name="front_user_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="block well">
                                    <div class="navbar">
                                        <div class="navbar-inner">
                                            <h5> <?= isset($edit_data['id']) ? $admin_products['edit_discountcoupons']['front'] : $admin_products['add_discountusers']['front']; ?></h5>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                                ...
                                                &nbsp; &nbsp; &nbsp; &nbsp;
                                                <!-- &nbsp; Individual &nbsp; &nbsp; &nbsp; &nbsp;<input type="radio" value="" class="coupon_prodsss prods1" checked/> -->
					    ...
					    number: true,
                                ...
                                // $('.multiple-select-users').select2().on('change', function(e) {
                                //     var selected_value = $(this).select2("val");

                                //     if (selected_value) {

                                //         if (($.inArray("All", selected_value) !== -1) && (selected_value.length > 1)) {
                                //             $(this).select2('val', selected_value);

                                //             var new_values = $.grep(selected_value, function(value) {
                                //                 return value != "All";
                                //             });
                                //             $(this).select2('val', new_values);
                                //         } else {
                                ...
                                }, jQuery.validator.format("Please enter end range   value greater than start."));

				$.validator.addMethod("decimalRange", function(value, element) {
                                    var parent_div = $(element).closest('.moreModel');                                    
				...
				}, jQuery.validator.format("Please enter the percentage with 3 digit decimal places."));
                                ...
                                }, jQuery.validator.format("Please enter the  value greater than  previous start."));
...
<script>
    $('.coupon_usersss').change(function() {
      ...
      $('.products_new_drop').select2({
        ...
        placeholder: $("#select_an_option").html(),
