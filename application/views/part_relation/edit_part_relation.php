                            ...
                            <form id="editPartRelation" name="editPartRelation" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/<?php echo $lang_id; ?>/part_relation/post_edit_part_relation/<?php echo $edit_data['id']; ?>">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="block well">
                                        ...
                                        <input type="hidden" id="product_parent" name="product_parent" value="<?php if (!empty($values)) {
                                                                                                                    echo implode(',', $values);
                                                                                                                } ?>" />
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <?php if ($pitem['multi_language'] == 1 && isset( $product_itemr[$pitem['id']])) { ?>
                                                                <a target="_blank" href="admin/<?php echo $lang_id; ?>/multilangue/index/<?php echo key($product_itemr[$pitem['id']]);; ?>/product_attributes_country/value" class="fancybox multi_language_edit admin_globe">
                                                                    <img src="assets/uploads/global.jpg" height="20" width="20">
                                                                </a>
                                                            <?php } ?>
                                                        <?php } ?>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">SEO Meta Kwywords:</label>
                                            <div class="controls">
