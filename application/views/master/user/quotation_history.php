                ...
                <div class="col-12 col-md-9">
                    <div class="my-account-content mb-50 h-100">
                        <div class="col-md-12 brand_complete_info">
                            <h4 class="orderHistory"><?php echo $all_titles->sidebar_quotations; ?></h4>
                                ...
                                <table class="w-100 table table-bordered my-table">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th>
                                                <label class="control-label"><?php echo $sales_order_preview->quot_expiry_date; ?></label>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $set_data->quotation_number; ?></td>
                                                    <td><?php echo date('Y-m-d', strtotime($set_data->expirydate)); ?></td>
                                                    <td><?php echo $set_data->amount . ' ' . $set_data->currency; ?></td>
                                                    <td><?php if ($set_data->status == 0) {
                                                            echo $admin_static_links['pending'];
                                                        } ?>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>/<?php echo $lang_id; ?>/user/quotation_pay/<?php echo $set_data->id; ?>" class="viewbtn"> <?php echo $admin_static_links['pay']; ?></a>
