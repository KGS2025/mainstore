                ...
                <div class="col-12 col-md-9">
                    <div class="my-account-content mb-50 h-100">
                        <div class="col-md-12 brand_complete_info">
                            <h4 class="orderHistory"><?php echo $general_instruction->order_history; ?></h4>
                                ...
                                <table class="w-100 table table-bordered my-table">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th>
                                            <label class="control-label"><?php echo $sales_order_preview->order_number; ?></label>
                                            ...
                                            <th><label class="control-label"><?php echo $payment_instructions->card_label_cardaction; ?></label></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $date; ?></td>
                                                    <td> <?php echo $set_data->order_number; ?></td>
                                                    <td><?php echo $set_data->amount . ' ' . $set_data->currency; ?></td>
                                                    <td><?php echo getOrderStatus($set_data->order_status); ?>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>/<?php echo $lang_id; ?>/user/vieworder/<?php echo $set_data->id; ?>/<?php echo $set_data->order_number; ?>" class="viewbtn"><?php echo $admin_static_links['static_view']; ?>&nbsp;&nbsp;</a>
                                                        <?php if (!empty($set_data->request_payment_type) || !empty($set_data->request_percentage)) { ?>
                                                            <br>                                                        <a href="<?php echo base_url(); ?>/<?php echo $lang_id; ?>/user/quotation_pay/<?php echo $set_data->quotation_id; ?>" class="viewbtn"><?php echo $admin_static_links['pay']; ?>&nbsp;&nbsp;</a>
</a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            ...
                                            <tr class="odd">
                                                <td class="dataTables" valign="top" colspan="7"><?= $admin_static_links['no_data_available']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
