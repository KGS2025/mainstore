    ...
    <div class="entry_door">
        ...
        <div class="alert-message block-message warning kgtmargin" style="text-align:center;">
            ...
            <div class="contact-opacity">
                <form class="form-horizontal" id="entry_door_form" role="form" action="<?php echo base_url() . $lang_id . '/'; ?>user/send_credit_verification_code" method="post" >
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-md-12 controls">
                            <span class="position-relative"><input type="radio" class="required_input"  name="salutation" value="Mr." <?php if ($entry_users_data1['applicant'] == 'Mr.') { ?> checked="checked"<?php } ?>/><label for="radio1"><?php echo $cart_instruction->mr_title; ?></label></span>
                            <span class="position-relative mx-3"><input type="radio" class="required_input"  name="salutation" value="Miss." <?php if ($entry_users_data1['applicant'] == 'Miss.') { ?> checked="checked"<?php } ?>/><label for="radio2"><?php echo $cart_instruction->ms_title; ?></label></span>
                            <span class="position-relative"><input type="radio" class="required_input"  name="salutation" value="Other" <?php if ($entry_users_data1['applicant'] == 'Other') { ?> checked="checked"<?php } ?>/><label for="radio3"><?php echo $cart_instruction->other_title; ?></label></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <?php if ($entry_users_data['entry_sms_confirm'] != 1) { ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-md-12">
                            <?php if ($entry_users_data['entry_email_confirm'] != 1) { ?>
            ...
            <div class="modal-body">
                ...
                <div class="box-content-modal">
                    <form action="#" id="entry_verification_form" method="post">
                        ...
                        $verificationfinalvar = [$entry_users_data['email'], $telephonevar];
                        ...
                        <?php $verification_message = str_replace('EMAILVAR', $entry_users_data['email'], $cart_instruction->verification_code_to_email); ?>
                        ...
                        <?php if ($entry_users_data['entry_email_confirm'] != 1 && $entry_users_data['entry_sms_confirm'] != 1) { ?>
                            ...
                            <div class="col-lg-12 float-start w-100 mb-3"> 
                                <div class="row">
                                    <div class="col-sm-6"><label><?php echo $cart_instruction->enter_sms_code; ?>:</label></div>
                                    <div class="col-sm-6"><input class="form-control" type="text" name="entry_verification_codesms" id="entry_verification_codesms"></div>
                                </div>
                            </div>
                        <?php } else if ($entry_users_data['entry_email_confirm'] != 1) { ?>
                            <div class="col-lg-12 float-start w-100 mb-3"> 
                                <div class="row">
                                    <div class="col-sm-6"><label><?php echo $cart_instruction->enter_email_code; ?>:  </label></div>
                                    <div class="col-sm-6"><input class="form-control" type="text" name="entry_verification_codemail" id="entry_verification_codemail"></div>
                            ...
                            <input type="hidden" name="entry_verification_codesms" value="<?php echo $entry_users_data['sms_code']; ?>" />                                             <?php } else if ($entry_users_data['entry_sms_confirm'] != 1) { ?>
                            <div class="col-lg-12 float-start w-100 mb-3"> 
                                <div class="row">
                                    <div class="col-sm-6"><label><?php echo $cart_instruction->enter_sms_code; ?>:</label></div>
                                    <div class="col-sm-6"><input class="form-control" type="text" name="entry_verification_codesms" id="entry_verification_codesms"></div>
                        ...
                        <div class="btn-modal toyota-page">
                            <div class="row">  
                                    ...
                                    <?php if ($lang_id == 'ar') { ?>
                                        <a href="javascript:void(0);" onclick="$('#notify_submit').modal('hide');window.location.href = '<?php echo base_url() . $lang_id . '/' . 'products'; ?>'" id="cart_pop_cancel" class="btn   actn-btn rounded"><i class="fa fa-angle-left"></i> <?php echo str_replace('<br />',' - ', $cart_instruction->cancel); ?> </a>
                                    <?php } else { ?>
                                        <a href="javascript:void(0);" onclick="$('#notify_submit').modal('hide');window.location.href = '<?php echo base_url() . $lang_id . '/' . 'products'; ?>'" id="cart_pop_cancel" class="btn   actn-btn rounded"><?php echo str_replace('<br />',' - ', $cart_instruction->cancel); ?> <i class="fa fa-angle-right"></i></a>
                                    <?php } ?>
                                    <?php if ($lang_id == 'ar') { ?>
                                        <a href="javascript:void(0);" class="btn   actn-btn rounded"
                                           id="resend_code"><i class="fa fa-angle-left"></i> <?php echo str_replace('<br />',' - ', $cart_instruction->resend); ?> </a>
                                    <?php } else { ?>
                    ...
                    <div class="btn-modal toyota-page">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php if ($lang_id == 'ar') { ?>
                                    <a href="<?php echo base_url() . $lang_id . '/'; ?>user/apply_credit" class="btn   actn-btn rounded"><i class="fa fa-angle-left"></i> <?php echo $general_instruction->edit; ?></a>
                                <?php } else { ?>
                                    <a href="<?php echo base_url() . $lang_id . '/'; ?>user/apply_credit" class="btn   actn-btn rounded"><?php echo $general_instruction->edit; ?><i class="fa fa-angle-right"></i></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal mt-3">
                       <?php if ($lang_id == 'ar') { ?>
                            <a href="javascript:void(0)" onClick="$('#modal_success').modal('hide'); window.location.href = ' <?php echo base_url() . $lang_id . '/' . 'user/send_credit_form_mail'; ?>'" class="floatright1 btn   actn-btn rounded"><i class="fa fa-angle-left"></i><?php echo $general_instruction->ok; ?> </a>
                       <?php } else { ?>
                            <a href="javascript:void(0)" onClick="$('#modal_success').modal('hide'); window.location.href = ' <?php echo base_url() . $lang_id . '/user/send_credit_form_mail' ?>'" class="floatright1 btn   actn-btn rounded"><?php echo $general_instruction->ok; ?> <i class="fa fa-angle-right"></i></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
