...
?>
                                         ...
                                         <div class="form-group float-start w-100 no_free_delivery"  id="ship_with_freight" style="<?php if ($free_delivery == 1 || $package_both_box_count < 1) {
                                                                                                            echo 'display:none;';
                                                                                                        } ?>">
    ...
    <?php if (!empty($cart_details)) { ?>
        <div class="nav-prex-next sticky_button_next d-flex flex-wrap align-items-center justify-content-between w-100" id="cart_buttons">
            <div class="productActionBtns d-flex align-items-center w-100 justify-content-end">
                ...
                <a href="javascript:void(0)" class="btn2  actn-btn2 rounded cart_submit_btn_color" style="margin-left: auto;" id="cart_checkout_footer"><?php echo $general_instruction->sbmt; ?></a>
            </div>
        </div>
    <?php } ?>
</div>
