...
<style>
    ...
    .incoterms_block{display:none;} 
    .incoterms_block_name{display:none;}
    .incoterms_block_account{display:none;} 
    #fetch_shipping_rate{display: none !important;}
    #shipping_rate_field_freight{display: none !important;}
</style>
<div class="mainContent px-3 px-lg-5">
	...
	<input type="hidden" value="continue" name="button_checkings" id="button_checkings">
    <input type="hidden" value="default" name="hidden_button_checkings" id="hidden_button_checkings">
	<input type="hidden" value="<?php echo $user_id; ?>" name="user_id" id="user_id">
	<input type="hidden" value="<?php echo ($this->session->userdata('front_validuser_data')['id']==null?0:$this->session->userdata('front_validuser_data')['id']);?>" name="hidden_session_check" id="hidden_session_check"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group  billingShippingcheck float-start w-100 mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <input type="hidden" id="radio1_hidden_value" value="<?php echo (isset($cart_users_data['billing_shipping_selection'])?$cart_users_data['billing_shipping_selection']:"100");?>">
                        ...
                        <?php if ($billing_info_check == 1 ||  $yes_checked == "checked") { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="formGrid d-grid gap-3 grid-col-3 <?php echo ($this->config->item('enable_shipping_method') == '0'?'backend_hide':'');?>">
                                    ...
                                    <div class="form-group float-start w-100 no_free_delivery incoterms_block" style="<?php if ($free_delivery == 1) {
                                                                                                            echo 'display:none;';
                                                                                                        } ?>">
						    ...
						    <input type="hidden" id="radio15_hidden_value" value="<?php echo (isset($cart_users_data['incoterms'])?$cart_users_data['incoterms']:"100");?>">
                                                    <div class="form-group float-start w-100">
                                                        <div class="col-lg-12">                                                                                                    
...
?>
                                         ...
                                         <div id="ship_with_freight_block">
                                    ...
                                    <div id="freight_display_block"><div class="form-group float-start w-100 no_free_delivery incoterms_block <?php echo ($this->config->item('enable_freight_mode') == '0'?'backend_hide':'');?>" style="<?php if ($free_delivery == 1) {
                                                                                                            echo 'display:none;';
                                                                                                        } ?>">
                                    ...
                                    <div class="form-group float-start w-100 no_free_delivery incoterms_block_name" style="<?php if ($free_delivery == 1) {
                                                                                                            echo 'display:none;';
                                                                                                        } ?>">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="w-100 float-start mt-2">
                                                <span id="fetch_shipping_rate" style="cursor:pointer;display:none;"><?php echo $general_instruction->fetch_shipping_rate; ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group float-start w-100 no_free_delivery incoterms_block_account" style="<?php if ($free_delivery == 1) {
                                                                                                            echo 'display:none;';
                                                                                                        } ?>">
                                            ...
                                            <div class="table-responsivefloat-start w-100" id="not_empty_cart">
                                                ...
                                                <div id="kgtcartactive" class="table table-bordered my-table productsbytype">
                                                    ...
                                                    foreach ($cart_details as $cart) {
                                                        ...
                                                        if($general_instruction->kgs_text == "Kg"){                                                            
                                                            if($cart->item_weight > 68){
                                                                $frieght_package = 1;
                                                            }
                                                        }else{
                                                            if($cart->item_weight/2.2 > 68){
                                                                $frieght_package = 1;
                                                            }
                                                        }
                                                        if($general_instruction->cm_text == "cm"){
                                                            if($cart->item_width >429 || $cart->item_width >429 || $cart->item_length >429 || $cart->item_height >429 ){
                                                                $frieght_package = 1;
                                                            }
                                                        }else{
                                                            if($cart->item_width >150 || $cart->item_width >150 || $cart->item_length >150 || $cart->item_height >150 ){
                                                                $frieght_package = 1;
                                                            }                                                            
                                                        }
                                                        $data['frieght_package'] = $frieght_package;                                      
    ...
    <?php if (!empty($cart_details)) { ?>
        <div class="nav-prex-next sticky_button_next d-flex flex-wrap align-items-center justify-content-between w-100" id="cart_buttons">
            <div class="productActionBtns d-flex align-items-center w-100 justify-content-end">
                <a href="<?php echo base_url() . $lang_id . '/products/product_list'; ?>" class="btn2  actn-btn2 rounded cart_back_btn_color" id="cart_back"><?php echo $general_instruction->back; ?></a>
                ...
                <a href="javascript:void(0)" class="btn2  actn-btn2 rounded cart_submit_btn_color" id="cart_checkout_footer"><?php echo $cart_instruction->cart_proceed; ?></a>
            </div>
        </div>
    <?php } ?>
</div>
...
<input type="hidden" id="hidden_package_both_box_count" value="<?php echo $frieght_package; ?>">
