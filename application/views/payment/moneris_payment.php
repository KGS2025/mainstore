    ...
    <div id="payment-panels" class="paymentPanel d-flex flex-column panel my-5">
        ...
        <div class="panel-body float-start w-100">
            ...
            <div class="payment_div" <?php if ($loginuserterm['credit_term_status'] == "1" &&  $limit > $total) {  ?> style="display:none;" <?php } ?>>
                ...
                <!-- Payment form -->
                <form id="form-moneris" method="POST" action="<?php echo base_url() . $lang_id . '/payment/moneris_purchase'; ?>" >
                
                    <div class="form-group row">
                        <label class="col-md-4 control-label"><?php echo $payment_instruction->card_number; ?></label>
                        <div class="col-md-8">
                        <input id="moneris_card" type="text"  name="moneris_card"  class="span12 form-control required_input"  placeholder="Card Number">  
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                        <input id="moneris_date" type="text"  name="moneris_date"  class="span12 form-control required_input"  placeholder="YYMM">  
                        <span class="red1"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                        <input id="moneris_code" type="text"  name="moneris_code"  class="span12 form-control required_input"  placeholder="CVC">  
                        <span class="red1"></span>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="span12 form-control required_input" id="captcha" placeholder="<?php echo $cart_instruction->captcha_text; ?>" name="captcha" data-form-field="captcha"  oninvalid="this.setCustomValidity('<?php if (isset($cart_instruction->invalid_captcha)) echo $cart_instruction->invalid_captcha; ?>');" onchange="try{setCustomValidity('')}catch(e){};" x-moz-errormessage="<?php if (isset($cart_instruction->invalid_captcha)) echo $cart_instruction->invalid_captcha; ?>">
                            <span class="red1"></span>

                            <span class="trynewcaptcha"><?php echo $cart_instruction->try_new_captcha_text; ?></span>
                        </div>
                    </div>
...
<span class="displaynon" id="credit_card_number"><?php if (isset($form_validation_instruction->credit_card_number)) echo $form_validation_instruction->credit_card_number; ?></span>
<span class="displaynon" id="credit_card_date"><?php if (isset($form_validation_instruction->credit_card_date)) echo $form_validation_instruction->credit_card_date; ?></span>
<span class="displaynon" id="credit_card_cvc"><?php if (isset($form_validation_instruction->credit_card_cvc)) echo $form_validation_instruction->credit_card_cvc; ?></span>
